...
public class MiniMarketDapelKph28 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            // Menampilkan menu
            System.out.println("\n=== Menu Mini Market ===");
            System.out.println("1. Beras - Rp 165.000");
            System.out.println("2. Gula - Rp 10.000");
            System.out.println("3. Minyak Goreng - Rp 19.000");
            System.out.println("4. Telur - Rp 42.000");
            System.out.println("5. Mie Instan - Rp 3.5000");
